...
class DynamicColsGridLayout(GridLayout):
    ...
    def child_width(self, child): return child.width
    def children_width(self, children): return sum(
        list(map(self.child_width, children)))

    def calc_row_width(self, children, *args):
